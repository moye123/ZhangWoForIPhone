...
- (void)downloadData{
    ...
    [_afmanager POST:[SITEAPI stringByAppendingFormat:@"&mod=income&ac=showinfo&page=%d",_page] parameters:params success:^(AFHTTPRequestOperation * _Nonnull operation, id  _Nonnull responseObject) {
